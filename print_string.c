...
{ 
    if (!print_string("The module has been inserted.  Hello world!")) {
		my_print_string_info("The module has been inserted.\n");
		my_print_string_err("Cannot get current_tty!\n");
	}
...
{ 
	if (!print_string("The module has been removed.  Farewell world!")) {
		my_print_string_info("The module has been removed.\n");
		my_print_string_err("Cannot get current_tty!\n");
	}
} 
